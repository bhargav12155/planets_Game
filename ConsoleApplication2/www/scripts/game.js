...
window.onload = function () {
    ...
    function create() {
        ...
        // bhargav this is for electric planet
        {
            ...
            var e01 = e0.sort(function () { return 0.5 - randomvariable });
        }
        {
...

        {
            ...
            var i01 = i0.sort(function () { return 0.5 - randomvariable });
        }
        {
        ...
        }
        {
            ...
            var l01 = l0.sort(function () { return 0.5 - randomvariable });
...
Main.HangerScene.prototype.setup = function () {
    ...
    var d1 = new DialogueObject('Bhargav', 'safe-t_pose_atEase', 0, true);
    d1.lines.push("Hello, you must be the new trainee! Welcome to the Planetary Safety Commission. My name is Bhargav SId, and I'll be assisting you on your missions. Let's get aboard the ship.");
    dialogue.push(d1);
...
Main.CockpitScene.prototype.setup = function () {
    ...
    var d1 = new DialogueObject('Bhargav', 'safe-t_pose_atEase', 1, true);
...
Main.UtilityBeltScene.prototype.setup = function () {
    ...
    var d1 = new DialogueObject('Bhargav', 'safe-t_pose_atEase', 1, false, true);
...
Main.AlienDialogueScene.prototype.setup = function () {
    ...
    if (currentPlanet == gasPlanetStates) {
        ...
        d1 = new DialogueObject('Mad Sims', 'boltian_pose_reg', 2, true);
...
Main.ElectricDialogue.prototype.setup = function () {
    ...
    var d4 = new DialogueObject('Mad Sims', 'boltian_pose_reg', 0, true);
    if (losses[1] == 0) {
        audio.pause();
...
Main.EW.prototype.setup = function () {
    ...
    var d5 = new DialogueObject('Bhargav', 'safe-t_pose_atEase', 0, true);
...
Main.badge.prototype.setup = function () {
    ...
    var d9 = new DialogueObject('Bhargav', 'safe-t_pose_atEase', 0, true);
...
Main.badgepic.prototype.setup = function () {
    ...
    var d9 = new DialogueObject('Bhargav', 'safe-t_pose_atEase', 0, true);
    d9.lines.push("Show to me.  Good luck on future missions, Captain!");
    dialogue.push(d9);
